...
export class LockstepNetcode {
    constructor(isHost, initialState, players, timestep, stateSyncPeriod, pollInput, broadcastInput, broadcastState) {
         ...
         */
        Object.defineProperty(this, "stateSyncPeriod", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "missedFrames", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "stateSyncsReceived", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "stateSyncsSent", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    checkAllInputsReady() {
        for (let player of this.players) {
            if (get(this.inputs, player).length === 0)
                return false;
        }
        return true;
    }
    ...
    processLocalInput() {
        ...
        DEV &&
            assert.isEmpty(this.inputs.get(localPlayer), "Local player already has input stored.");
