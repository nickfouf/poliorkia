...
export class GameWrapper {
    ...
    checkChannel(channel) {
        assert.isTrue(this.isChannelOrdered(channel), "Data Channel must be ordered.");
    ...
    constructor(gameClass) {
        ...
        Object.defineProperty(this, "inputReader", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "playerPausedIndicator", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "pingMeasure", {
            ...
            configurable: true,
            writable: true,
            value: new EWMASD(0.2)
        });
        Object.defineProperty(this, "rtcStats", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
      ...
      `;
        ...
        this.inputReader = new DefaultInputReader(document.body, this.canvas, this.gameClass.canvasSize, this.gameClass.pointerLock || false, this.gameClass.preventContextMenu || false, this.gameClass.touchControls || {});
    }
    /**
    ...
    renderRTCStats(stats) {
      ...
      <details>
        ...
        ${[...stats.values()].map((report) => lit.html `<div style="margin-left: 10px;">
            <details>
    ...
    async watchRTCStats(connection) {
