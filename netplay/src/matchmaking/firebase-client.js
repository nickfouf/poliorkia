import { ref, onValue, set, runTransaction, push, onDisconnect, serverTimestamp, onChildAdded, off } from "firebase/database";
...
export class FirebasePeerConnection extends EventEmitter {
    constructor(myId, peerId, roomRef, initiator, iceServers = [{ urls: "stun:stun.l.google.com:19302" }]) {
        super();
        ...
        Object.defineProperty(this, "roomRef", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: roomRef
...
export class FirebaseMatchmaker {
    constructor() {
        ...
        Object.defineProperty(this, "serverTimeOffset", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "onMatchFound", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new TypedEvent()
         ...
         */
        Object.defineProperty(this, "matchmakeInterval", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    connect(roomId, otherUserId, amIHost) {
